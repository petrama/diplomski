...
def configure_learning_rate(flags, num_samples_per_epoch, global_step,learning_rate_multiplier=1):
    ...
    lr=flags.learning_rate*learning_rate_multiplier
...
def get_variables_to_train(flags):
    ...
    for v in variables_to_train:
        ...
        if v.name.endswith('biases:0'):
            vars_biases.append(v)
        else:
            vars_weigths.append(v)

    print(len(vars_weigths),len(vars_biases))
    return vars_weigths,vars_biases

...
def plot_training_progress(save_dir, data):
  ...
  fig, ((ax1, ax2),  (ax3, ax4), (ax5, ax6)) = plt.subplots(3, 2, figsize=(18, 8))
...
def plot_training_progress_new(save_dir, data):
  print('plot training progress: ', data)
  fig, ((ax1, ax2), (ax7,ax8), (ax3, ax4), (ax5, ax6)) = plt.subplots(4, 2, figsize=(24, 8))
  ...
  ax7.set_title('Classification Loss')
  ax7.plot(x_data, data['train_celoss'], marker='o', color=train_color,
           linewidth=linewidth, linestyle='-', label='train')
  ax7.plot(x_data, data['valid_celoss'], marker='o', color=val_color,
           linewidth=linewidth, linestyle='-', label='validation')
  ax7.legend(loc='upper right', fontsize=legend_size)

  ax8.set_title('Regression Loss')
  ax8.plot(x_data, data['train_regloss'], marker='o', color=train_color,
           linewidth=linewidth, linestyle='-', label='train')
  ax8.plot(x_data, data['valid_regloss'], marker='o', color=val_color,
           linewidth=linewidth, linestyle='-', label='validation')
  ax8.legend(loc='upper right', fontsize=legend_size)

...
from preprocessing import petra_vgg_preprocessing
...
def get_preprocessing(name, is_training=False):
    ...
    Returns:
      preprocessing_fn: A function that preprocessing a single image (pre-batch)._
